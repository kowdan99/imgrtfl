    ...
    return (
        <div>
            ...
            <Grid minH="100vh" p={3}>
                    ...
                    <Grid minH="100vh" p={3}>
                    <Input placeholder='Enter Phone Number' width={'auto'} marginTop={200} value={inputValue} />
                    {shouldShowComponent && <Input placeholder='Enter OTP code' width={'auto'} marginTop={200}  />}
                    {shouldShowComponent && <Button colorScheme='undefined' size='md' >Verify Code</Button>}
                    <Button colorScheme='undefined' isLoading={isLoading} size='md' >Send OTP</Button>
                    </Grid>
                    </VStack>
            </Grid>
            </Box>
